...
# Train the model
model.fit(train_dataset, epochs=5, callbacks=[checkpoint_callback])
...
predicted_depth = model.predict(test_image)
...
plt.subplot(1, 3, 2)
plt.imshow(test_depth[0].numpy(), cmap='jet')
plt.title('Ground Truth Depth')

plt.subplot(1, 3, 3)
plt.imshow(predicted_depth.squeeze(), cmap='jet')  # Remove singleton dimension
